...
forked_block = "000005cc24f7684d86fcd6f737fb271cf939cac84494e8c2e8a4ced2f388c4f2"
...
line3, = plt.plot(times_list, forked_mined_buckets, label="blocks mined / {}s".format(time_interval)) 
line4, = plt.plot(times_list, forked_aggregate_buckets, label="total blocks mined")
